...
IL_000f_1:
			...
			}
			{
				...
				VirtualActionInvoker1< uint8_t >::Invoke(25 /* System.Void System.IO.Stream::WriteByte(System.Byte) */, L_11, (uint8_t)((int32_t)32));
				goto IL_006c_1;
			}
...
IL_0042_1:
			...
			}
			{
				...
				VirtualActionInvoker1< uint8_t >::Invoke(25 /* System.Void System.IO.Stream::WriteByte(System.Byte) */, L_21, L_25);
				goto IL_006c_1;
			}
...
IL_0060_1:
			{
				...
				VirtualActionInvoker1< uint8_t >::Invoke(25 /* System.Void System.IO.Stream::WriteByte(System.Byte) */, L_26, L_30);
			}
...
IL_0071_1:
			...
			}
			{
				...
				L_36 = VirtualFuncInvoker0< ByteU5BU5D_tA6237BF417AE52AD70CFB4EF24A7A82613DF9031* >::Invoke(29 /* System.Byte[] System.IO.MemoryStream::ToArray() */, L_35);
				V_5 = L_36;
				goto IL_0092;
			}
		}// end try (depth: 1)
